Function Get-brshConversionsHelp {
	<#
	.SYNOPSIS
	List commands available in the brshConversions Module
	...
	$all = @()
	$list = Get-Command -Type function -Module "brshConversions" | Where-Object { $_.Name -in $script:ShowHelp}
	$list | ForEach-Object {
